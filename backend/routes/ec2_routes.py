...
from controllers.ec2_controller import (
    ...
    list_key_pairs_controller,
    create_key_pair_controller,
...
ec2_bp.route('', methods=['GET'], endpoint='list_ec2')(jwt_required_custom(list_ec2_controller))
ec2_bp.route('/instances', methods=['GET'], endpoint='list_ec2_instances')(jwt_required_custom(list_ec2_controller))
...
ec2_bp.route('/key-pairs', methods=['GET'])(jwt_required_custom(list_key_pairs_controller))
ec2_bp.route('/key-pairs', methods=['POST'])(jwt_required_custom(create_key_pair_controller))
